...
public class BookDirectoryTestSuite {
    ...
    @Test
    public void testListBooksInHandsOf_zeroBooks(){
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> resultListOfZeroBooks = new ArrayList<>();
        LibraryUser libraryUser = new LibraryUser("Jan", "Kowalski", "0234567890");
    ...
    @Test
    public void testListBooksInHandsOf_oneBook(){
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
    ...
    @Test
    public void testListBooksInHandsOf_fiveBooks(){
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
